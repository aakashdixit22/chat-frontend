    ...
    <MDBFooter className='text-center footer-bg' color='white'>
      <MDBContainer className='p-4'>
        ...
        <section className='mb-4' style={{paddingTop:'20px'}}>
          ...
          <MDBBtn outline color="light" floating className='m-1 rounded-circle' href='mailto:aakashdixit227@gmail.com' role='button'>
      ...
      <div className='text-center p-3' style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
        ...
        <a className='text-white' href='https://github.com/aakashdixit22'>
           Aakash Dixit
        </a>
      </div>
    </MDBFooter>
